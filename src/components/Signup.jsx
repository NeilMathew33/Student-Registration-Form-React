...
<h4 className='text-center'>User Sign Up</h4>
        ...
        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
         ...
         <textarea name="coursename" id="" className="form-control" value={input.coursename} onChange={handleInput}></textarea>
        </div>
        ...
        <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
          <label htmlFor="" className="form-label">Online or Offline</label>
          <select name="onlineoroffline" id="" className="form-control" value={input.onlineoroffline} onChange={handleInput}>
